...
public class TracksController : ControllerBase
{
    ...
    {
        if (_context.Tracks == null) return NotFound();
    ...
    {
        if (id != tracks.Id) return BadRequest();
    ...
    {
        if (_context.Tracks == null) return Problem("Entity set 'MusicAPIContext.Tracks'  is null.");
